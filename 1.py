...
table = prettytable.PrettyTable(["Размер списка", "Время пузырька", "Время быстрой","Время сортировки выбором select"])
x=[]
y1=[]
y2=[]
y3=[]
...
for N in range(1000,5001,1000):
    ...
    print("Cортировка  выбором select " + str(N) + "   заняла   " + str((t6 - t5).total_seconds()) + "c")
